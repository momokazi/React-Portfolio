...
const About: React.FC<any> = () => {
  ...
  return (
    <section id="about" className="py-24 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="prose prose-invert max-w-none text-slate-600 dark:text-slate-400 mb-8 leading-loose">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div className="p-4 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800">
                <div className="flex items-center gap-3 mb-2 text-slate-900 dark:text-white font-semibold">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-slate-600 dark:text-slate-400">2+ Years</p>
              </div>
            </div>
          ...
          {/* Timeline / Visual */}
          <div className="relative border-l-2 border-slate-200 dark:border-slate-800 ml-3 lg:ml-0 pl-8 space-y-12">
            {recentExperience.map((item, index) => (
              <div key={index} className="relative">
                <span className={`absolute -left-[41px] top-1 h-5 w-5 rounded-full border-4 border-white dark:border-slate-900 ${index === 0 ? 'bg-primary' : index === 1 ? 'bg-secondary' : 'bg-slate-400 dark:bg-slate-600'}`}></span>
            ...
            <div className="relative">
               <Link to="/about" className="text-sm text-slate-500 hover:text-primary dark:hover:text-white transition-colors flex items-center gap-1 mt-4">
