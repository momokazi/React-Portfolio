    ...
    <div className="min-h-screen bg-slate-950 pt-32 pb-24">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-24">
          ...
          >
            <div className="relative w-full max-w-[400px] aspect-[3/4] rounded-3xl overflow-hidden border-4 border-slate-800 shadow-2xl group">
              <img 
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
              {stats.map((stat, index) => (
                <div key={index} className="p-4 bg-slate-900 rounded-xl border border-slate-800 text-center">
            ...
            <div className="flex gap-4">
              ...
              <button 
                disabled
                className="px-8 py-3 bg-slate-900 border border-slate-800 text-slate-500 font-medium rounded-xl cursor-not-allowed flex items-center gap-2"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative space-y-12">
            {/* Vertical Line */}
            <div className="absolute left-[28px] top-4 bottom-4 w-0.5 bg-slate-800"></div>
            ...
            {EXPERIENCE.map((item, index) => (
              ...
              >
                {/* Logo Bubble */}
                <div className="relative z-10 w-14 h-14 rounded-full flex items-center justify-center shrink-0 border-4 border-slate-950 shadow-xl bg-white overflow-hidden">
                  {item.logo ? (
                ...
                {/* Content Card */}
                <div className="flex-1 bg-slate-900 p-6 rounded-2xl border border-slate-800 hover:border-slate-600 transition-colors">
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-2 gap-2">
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-primary font-medium text-sm">
                        ...
                        <span className="text-slate-400 font-normal">{item.type}</span>
                      </div>
                    </div>
                    <span className="inline-block px-3 py-1 bg-slate-950 rounded-lg text-xs text-slate-400 font-mono border border-slate-800 self-start">
                      {item.period}
                    </span>
                  </div>
                  
                  <div className="flex items-center gap-2 text-xs text-slate-500 mb-4 uppercase tracking-wide">
             ...
             <motion.div 
                ...
                className="relative flex gap-8 items-start group"
              >
                <div className="relative z-10 w-14 h-14 rounded-full flex items-center justify-center shrink-0 border-4 border-slate-950 shadow-xl bg-slate-700 text-white">
                 ...
                 <div className="flex-1 bg-slate-900 p-6 rounded-2xl border border-slate-800 hover:border-slate-600 transition-colors">
                    ...
                    <p className="text-slate-400 text-sm">Graduated with a focus on Software Engineering, Data Structures, and Mobile Computing.</p>
                 </div>
              </motion.div>
          </div>
        </div>
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-slate-900/50 rounded-3xl border border-slate-800 hover:bg-slate-900 transition-colors">
              <div className="w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center text-primary mb-6">
                <Code2 size={24} />
              </div>
            ...
            <div className="p-8 bg-slate-900/50 rounded-3xl border border-slate-800 hover:bg-slate-900 transition-colors">
              <div className="w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center text-secondary mb-6">
                <Heart size={24} />
              </div>
            ...
            <div className="p-8 bg-slate-900/50 rounded-3xl border border-slate-800 hover:bg-slate-900 transition-colors">
              <div className="w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center text-pink-400 mb-6">
                <Coffee size={24} />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Continuous Delivery</h3>
              <p className="text-slate-400">
